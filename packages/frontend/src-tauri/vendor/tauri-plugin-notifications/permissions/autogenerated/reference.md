...
`notifications:allow-get-android-foreground-sync-status`

</td>
<td>

Enables the get_android_foreground_sync_status command without any pre-configured scope.
...
`notifications:deny-get-android-foreground-sync-status`

</td>
<td>

Denies the get_android_foreground_sync_status command without any pre-configured scope.
...
`notifications:allow-start-android-foreground-sync`

</td>
<td>

Enables the start_android_foreground_sync command without any pre-configured scope.
...
`notifications:deny-start-android-foreground-sync`

</td>
<td>

Denies the start_android_foreground_sync command without any pre-configured scope.
...
`notifications:allow-stop-android-foreground-sync`

</td>
<td>

Enables the stop_android_foreground_sync command without any pre-configured scope.
...
`notifications:deny-stop-android-foreground-sync`

</td>
<td>

Denies the stop_android_foreground_sync command without any pre-configured scope.
