...
3. Maintain exactly three distinct Security decision cards. Research only when `proposalSlotsNeeded` requires it. Compare the full 90-day history and semantic evidence; replace duplicate candidates rather than counting them.
