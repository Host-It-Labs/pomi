...
function privateKeyBodyToDer(value) {
...
export function normalizePrivateKey(value) {
  const normalized = stripSurroundingQuotes(normalizeLineBreaks(String(value)));
...
export function createPrivateKeyForSigning(value) {
